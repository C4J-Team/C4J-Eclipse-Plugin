...
public class ChooseMemberDialog<T> extends PopupDialog implements DisposeListener {
	private TreeViewer treeViewer;
	private T selectedElement;
	private final ITreeContentAndDefaultSelectionProvider contentProvider;

	public ChooseMemberDialog(String titleText, ITreeContentAndDefaultSelectionProvider contentProvider) {
		this(titleText, null, contentProvider);
	}

	public ChooseMemberDialog(String titleText, String infoText,
			ITreeContentAndDefaultSelectionProvider contentProvider) {
		super(getDefaultShell(), PopupDialog.INFOPOPUP_SHELLSTYLE, true, false, false, false, false,
				titleText, infoText);
	...
	private static class LabelProvider extends JavaElementLabelProvider {
		...
		public String getText(Object element) {
			if (element instanceof TreeActionElement) {
				...
				return String.format("%s - %s", type.getElementName(), type.getPackageFragment()
						.getElementName());
			}
